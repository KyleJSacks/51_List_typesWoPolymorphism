...
public class List_inArraySlots {
    ...
    private static final int INTEGERS = 0;
    private static final int DOUBLES = 1;
    private static final int STRINGS = 2;
    ...
    public String toString() {
      ...
      for (int index = 0; index < filledElements; index++){
        ...
        //check if int
        if (type == INTEGERS) stringRep += intElements[index] + ",";
        //check if double
        else if (type == DOUBLES) stringRep += doubleElements[index] + ",";
        //otherwise use stringElements
        else stringRep += stringElements[index] + ",";
      }
